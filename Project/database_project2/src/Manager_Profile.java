...
public class Manager_Profile {
    ...
    Manager_Profile(){
        ...
        manager_ID_txt.setLayoutY(scene_height-730);
        manager_ID_txt.setFill(Color.BLACK);
        manager_ID_txt.setFont(Font.font("Arial",FontWeight.BOLD,20 ));
        
        manager_name_txt = new Text("NAME");
        manager_name_txt.setLayoutX(scene_width-900);
        manager_name_txt.setLayoutY(scene_height-680);
        manager_name_txt.setFill(Color.BLACK);
        manager_name_txt.setFont(Font.font("Arial",FontWeight.BOLD,20 ));
        ...
        manager_ID_result_txt.setLayoutY(scene_height-730);
        manager_ID_result_txt.setFill(Color.BLACK);
        manager_ID_result_txt.setFont(Font.font("Arial",FontWeight.BOLD,20 ));
        
        manager_name_result_txt = new Text("skdj");
        manager_name_result_txt.setLayoutX(scene_width-650);
        manager_name_result_txt.setLayoutY(scene_height-680);
        manager_name_result_txt.setFill(Color.BLACK);
        manager_name_result_txt.setFont(Font.font("Arial",FontWeight.BOLD,20 ));
        ...
        grp.getChildren().addAll(address_result_txt,address_txt,manager_ID_result_txt,manager_ID_txt,manager_name_result_txt,manager_name_txt,
                ...
                join_date_result_txt,join_date_txt,end_date_result_txt,end_date_txt);
