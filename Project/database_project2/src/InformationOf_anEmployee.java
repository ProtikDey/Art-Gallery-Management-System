 ...
 * @author User
 */
public class InformationOf_anEmployee {
    ...
    InformationOf_anEmployee() {
        ...
        employee_name_txt.setLayoutY(scene_height-500);
        employee_name_txt.setFill(Color.BLACK);
        employee_name_txt.setFont(Font.font("Times New Roman",FontWeight.BOLD,20 ));
        
        manager_name_txt= new Text("MANAGER NAME");
        manager_name_txt.setLayoutX(scene_width-900);
        manager_name_txt.setLayoutY(scene_height-470);
        manager_name_txt.setFill(Color.BLACK);
        manager_name_txt.setFont(Font.font("Times New Roman",FontWeight.BOLD,20 ));
        
         address_txt= new Text("ADDRESS");
        address_txt.setLayoutX(scene_width-900);
        address_txt.setLayoutY(scene_height-440);
        ...
        sex_txt.setLayoutY(scene_height-410);
        ...
        salary_txt.setLayoutY(scene_height-380);
        salary_txt.setFill(Color.BLACK);
        salary_txt.setFont(Font.font("Times New Roman",FontWeight.BOLD,20 ));
        
        phone_no_txt= new Text("PHONE NO");
        phone_no_txt.setLayoutX(scene_width-900);
        phone_no_txt.setLayoutY(scene_height-350);
        ...
        email_ID_txt.setLayoutY(scene_height-320);
        ...
        dateOf_birth_txt.setLayoutY(scene_height-290);
        ...
        join_date_txt.setLayoutY(scene_height-260);
        join_date_txt.setFill(Color.BLACK);
        join_date_txt.setFont(Font.font("Times New Roman",FontWeight.BOLD,20 ));
        
         end_date_txt= new Text("END DATE");
        end_date_txt.setLayoutX(scene_width-900);
        end_date_txt.setLayoutY(scene_height-230);
        end_date_txt.setFill(Color.BLACK);
        end_date_txt.setFont(Font.font("Times New Roman",FontWeight.BOLD,20 ));
        
        
        
        
        
        employee_name_result_txt= new Text("");
        employee_name_result_txt.setLayoutX(scene_width-650);
        employee_name_result_txt.setLayoutY(scene_height-500);
        employee_name_result_txt.setFill(Color.BLACK);
        employee_name_result_txt.setFont(Font.font("Times New Roman",FontWeight.BOLD,20 ));
        
        
        manager_name_result_txt= new Text();
        manager_name_result_txt.setLayoutX(scene_width-650);
        manager_name_result_txt.setLayoutY(scene_height-470);
        manager_name_result_txt.setFill(Color.BLACK);
        manager_name_result_txt.setFont(Font.font("Times New Roman",FontWeight.BOLD,20 ));
        
         address_result_txt= new Text("");
        address_result_txt.setLayoutX(scene_width-650);
        address_result_txt.setLayoutY(scene_height-440);
        ...
        email_ID_result_txt.setLayoutY(scene_height-320);
        ...
        dateOf_birth_result_txt.setLayoutY(scene_height-290);
        dateOf_birth_result_txt.setFill(Color.BLACK);
        dateOf_birth_result_txt.setFont(Font.font("Times New Roman",FontWeight.BOLD,20 ));
        
        join_date_result_txt= new Text("");
        join_date_result_txt.setLayoutX(scene_width-650);
        join_date_result_txt.setLayoutY(scene_height-260);
        join_date_result_txt.setFill(Color.BLACK);
        join_date_result_txt.setFont(Font.font("Times New Roman",FontWeight.BOLD,20 ));
        
        
         end_date_result_txt= new Text("");
        end_date_result_txt.setLayoutX(scene_width-650);
        end_date_result_txt.setLayoutY(scene_height-230);
        end_date_result_txt.setFill(Color.BLACK);
        end_date_result_txt.setFont(Font.font("Times New Roman",FontWeight.BOLD,20 ));
        ...
        grp.getChildren().addAll(address_result_txt,address_txt,dateOf_birth_result_txt,dateOf_birth_txt,email_ID_result_txt,email_ID_txt,
                employee_name_result_txt,employee_name_txt,end_date_result_txt,end_date_txt,join_date_result_txt,join_date_txt,
                manager_name_result_txt,manager_name_txt,phone_no_result_txt,phone_no_txt,salary_result_txt,salary_txt,sex_result_txt,sex_txt);
